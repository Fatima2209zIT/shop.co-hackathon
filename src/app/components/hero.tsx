...
export default function Hero() {
  return (
    <div className="lg:w-[1440px] w-[410px] lg:h-[663px] h-[853px] bg-[#F2F0F1] flex ">
      ...
      {/* shop button */}
      <a href="/casual"><button className="absolute lg:w-[210px] h-[52px] w-[358px] left-[16px] top-[340px] lg:top-[140px] lg:ml-[100px] lg:mt-[380px] rounded-[62px] bg-black text-white px-[54px] py-[16px] gap-3 font-medium text-[16px] leading-[21.6px] hover:bg-[#8b8787fb]">
        Shop Now</button>
        </a>
